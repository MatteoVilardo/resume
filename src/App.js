...
function App() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen w-full bg-[#020617] text-white selection:bg-white/20">
      ...
      <div className="relative z-10">
        ...
        <div className="relative h-screen overflow-hidden">
          ...
          >
            ...
            >
              <span className="text-[10px] font-black uppercase tracking-[0.2em]">Explore My Work</span>
              <div className="w-[1px] h-12 bg-gradient-to-b from-transparent via-current to-transparent" style={{ color: currentTheme.accent }} />
            </motion.div>
          </motion.section>
        </div>
            ...
            <TracingBeam className="px-6">
              <div className="max-w-2xl mx-auto antialiased pt-4 relative">
                {DATA.experience.map((item, index) => (
                  ...
                  >
                    <div className="absolute -left-[32px] md:-left-[91px] top-2 z-20">
                      <PulseDot 
                        size={index === 0 ? "lg" : "md"} 
                        color="custom" 
                    ...
                    <div className={cn(
                      "inline-flex items-center gap-2 px-3 py-1 rounded-full border mb-6 backdrop-blur-md transition-all duration-500",
...
const SectionHeading = ({ title, subtitle, description, accentColor }) => (
...
const PulseDot = ({ size = "md", color = "blue", active = true, className, customColor }) => {
  const sizes = {
    xs: "h-1.5 w-1.5",
    sm: "h-2 w-2",
    md: "h-3 w-3",
...
const ContactIcon = ({ icon, href, isExternal, label, themeColor }) => (
  <a 
    href={href} 
